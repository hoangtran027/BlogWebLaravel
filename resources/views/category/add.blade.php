            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex items-center justify-between">
                        <p class="mt-[20px] font-bold uppercase text-red-400 text-[30px]">Add category</p>
                        <a href="{{route('category.index')}}" class="bg-red-400 text-white px-4 py-2 rounded-[8px] hover:bg-red-100 hover:text-black">View All</a>
                    </div>
                    <br>
                    @if ($errors->any())
                    ...
                    <form action="{{route('category.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="sm:col-span-4 mt-4">
                            ...
                            <div class="mt-2">
                              <input id="detail" name="detail" type="text" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                        <div class="sm:col-span-4 mt-4">
